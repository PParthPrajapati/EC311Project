...
#set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 }  [get_ports { tx_busy }]; #IO_L18P_T2_A24_15 Sch=led[0]
#set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 }  [get_ports { valid }]; #IO_L24P_T3_RS1_15 Sch=led[1]
...
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { dot }]; #IO_L4N_T0_D05_14 Sch=btnu
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { char_end }]; #IO_L12P_T1_MRCC_14 Sch=btnl
...
#set_property -dict { PACKAGE_PIN C4    IOSTANDARD LVCMOS33 } [get_ports { tx_line }]; #IO_L7P_T1_AD6P_35 Sch=uart_txd_in
